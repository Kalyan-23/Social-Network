...
const Page = ({ params }) => {
  ...
  }, [currentStoryIndex, groupedStories, storyToShow]);
  ...
  }, [storyToShow, currentStoryIndex, isPlaying, groupedStories]);
  ...
  useEffect(() => {
    ...
    clearInterval(progressIntervalRef.current);
    return undefined;
  }, [isPlaying, currentStoryIndex, elapsedTime, handleNextStory, storyDuration]);
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/" className="flex items-center">
              <motion.img
                ...
                className="w-10 mr-2"
              />
              <span className="font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent text-xl">Socio</span>
            </Link>
          </div>
