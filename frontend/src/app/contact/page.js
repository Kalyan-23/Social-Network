...
export default function ContactPage() {
  ...
  const socialMedia = [
    ...
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/anirudh_kaluru/',
      icon: <FaInstagram className="text-2xl" />,
      description: 'Follow my visual journey and creative moments.',
      username: 'anirudh_kaluru',
  ...
  const contactMethods = [
    {
      ...
      action: 'mailto:anirudhkaluru95@gmail.com',
    ...
    },
    {
      ...
      action: 'https://wa.me/917396023506',
          ...
          >
            <div className="bg-gray-50 py-12 px-6 rounded-2xl max-w-3xl mx-auto">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="https://anirudhkaluru95.wixstudio.io/my-site"
                target="_blank"
                rel="noopener noreferrer"
