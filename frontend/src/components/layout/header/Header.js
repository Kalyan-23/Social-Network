          ...
          >
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <span className="font-bold text-lg bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent group-hover:from-purple-600 group-hover:to-indigo-600 transition-all duration-500">Socio</span>
              </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-3">
              ...
              <a
                href={"https://github.com/Kalyan-23"}
                target='_blank'
                rel="noreferrer"
                className="p-2 rounded-full hover:bg-gray-100 transition-colors md:block hidden"
              >
                <img src='https://cdn-icons-png.flaticon.com/512/25/25231.png' alt="GitHub profile" className="w-6 h-6" />
              </a>
            </div>
          </motion.header>
